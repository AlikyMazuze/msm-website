        ...
        <div className="flex flex-wrap items-center">
            <div className="flex flex-shrink md:w-1/3 justify-center md:justify-start text-white">
                <a href="#" aria-label="Home">
                    <img src="/img/core-img/Logo PNG.png" alt="MSM" className="w-1/2 h-2/3 object-contain"/>
                </a>
            </div>
            ...
            <div className="flex flex-1 md:w-1/3 justify-center md:justify-start text-white px-2">
                <span className="relative w-full">
                    ...
                    <div className="absolute search-icon top-[1rem] left-[0.8rem]">
                ...
                <ul className="list-reset flex justify-between flex-1 md:flex-none items-center">
                    ...
                    <li className="flex-1 md:flex-none md:mr-3">
                        <div className="relative inline-block">
                            ...
                            }}  className="drop-button text-white py-2 px-2"> <span className="pr-2"><i className="em em-robot_face"></i></span> Hi, User <svg className="h-3 fill-current inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                            ...
                            <div id="myDropdown" className="dropdownlist absolute bg-gray-800 text-white right-0 mt-3 p-3 overflow-auto z-30 invisible">
                                ...
                                <a href="#" className="p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block"><i className="fa fa-user fa-fw"></i> Perfil</a>
                                <a href="#" className="p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block"><i className="fa fa-cog fa-fw"></i> Definições</a>
